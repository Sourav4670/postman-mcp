...
class GetDuplicateCollectionTaskStatusTool(ToolHandler):
    """Get duplication task status"""
    
    def __init__(self):
        super().__init__("getDuplicateCollectionTaskStatus")
    ...
    async def run_tool(self, args: dict) -> list[TextContent]:
        task_id = args["taskId"]
        result = await postman_api_call("GET", f"/collection-duplicate-tasks/{task_id}")
        return [TextContent(type="text", text=json.dumps(result, indent=2))]
...
class GetEnvironmentTool(ToolHandler):
    """Get environment information"""
    
    def __init__(self):
        super().__init__("getEnvironment")
    ...
    async def run_tool(self, args: dict) -> list[TextContent]:
        ...
        result = await postman_api_call("GET", f"/environments/{env_id}")
        return [TextContent(type="text", text=json.dumps(result, indent=2))]
...
class PublishMockTool(ToolHandler):
    """Publish mock server"""
    
    def __init__(self):
        super().__init__("publishMock")
    ...
    async def run_tool(self, args: dict) -> list[TextContent]:
        mock_id = args["mockId"]
        result = await postman_api_call("POST", f"/mocks/{mock_id}/publish")
        return [TextContent(type="text", text=json.dumps(result, indent=2))]
...
class GetAllSpecsTool(ToolHandler):
    """Get all API specifications"""
    
    def __init__(self):
        super().__init__("getAllSpecs")
...
class GetSpecFilesTool(ToolHandler):
    """Get all spec files"""
    
    def __init__(self):
        super().__init__("getSpecFiles")
...
class UpdateSpecFileTool(ToolHandler):
    """Update spec file"""
    
    def __init__(self):
        super().__init__("updateSpecFile")
...
class GetGeneratedCollectionSpecsTool(ToolHandler):
    """Get generated spec for collection"""
    
    def __init__(self):
        super().__init__("getGeneratedCollectionSpecs")
...
class SyncSpecWithCollectionTool(ToolHandler):
    """Sync spec with collection"""
    
    def __init__(self):
        super().__init__("syncSpecWithCollection")
...
class GetWorkspaceTool(ToolHandler):
    """Get workspace information"""
    
    def __init__(self):
        super().__init__("getWorkspace")
    ...
    async def run_tool(self, args: dict) -> list[TextContent]:
        ...
        result = await postman_api_call("GET", f"/workspaces/{workspace_id}", params=params)
        return [TextContent(type="text", text=json.dumps(result, indent=2))]


class GetWorkspacesTool(ToolHandler):
    """Get all workspaces"""
    
    def __init__(self):
        super().__init__("getWorkspaces")
    ...
    async def run_tool(self, args: dict) -> list[TextContent]:
        ...
        result = await postman_api_call("GET", "/workspaces", params=params)
        return [TextContent(type="text", text=json.dumps(result, indent=2))]
...
class RunCollectionTool(ToolHandler):
    """Run Postman collection"""
    
    def __init__(self):
        super().__init__("runCollection")
